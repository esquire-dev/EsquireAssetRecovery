...
export function TeamCard({ name, title }: TeamCardProps) {
  return (
    <article className="rounded-md border border-gold/20 bg-beige p-7 text-center shadow-[0_10px_30px_rgba(32,31,28,0.04)] transition-colors duration-300 hover:border-gold">
      <div
        aria-hidden="true"
